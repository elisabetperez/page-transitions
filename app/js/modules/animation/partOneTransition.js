...
class PartOneTransition extends Highway.Transition{
    in({from, to, done}){
        ...
        gsap.set(document.querySelector('.loader.part'), {opacity: 1});
        ...
        gsap.to(document.querySelector(".b--hero-a"), {
            ...
            onComplete: () => {
                ...
                window.scrollTo(0, 0);
                setTimeout(() => {
                    gsap.to(document.querySelector('.loader.part'), {duration: 1, opacity: 0});
                }, 1000);
            }
        });
    }
    ...
    out({from, done}){
        window.scrollTo(0, 0);
        gsap.to(document.querySelector('.loader.part'), {
            opacity: 1,
            duration: 1,
            ease: "power2.out",
            onComplete: () => {
